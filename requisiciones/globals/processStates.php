...
if(isset($_POST["estados"])){
    ...
    $countryArr = array( 
        ...
        "Campeche","Chiapas","Chihuahua","Coahuila","Colima","CDMX","Durango","MÃ©xico","Guanajuato",
        "Guerrero","Hidalgo","Jalisco","MichoacÃ¡n","Morelos","Nayarit","Nuevo LeÃ³n","Oaxaca","Puebla",
        "QuerÃ©taro","Quintana Roo","San Luis PotosÃ­","Sinaloa","Sonora","Tabasco","Tamaulipas","Tlaxcala",
...
if(isset($_POST["municipios"])){
    // Capture selected country
    echo $municipios = utf8_encode($_POST["municipios"]);
...
"Alabama" => array("Birmingham","Montgomery","Mobile","Huntsville"),
"Alaska" => array("Anchorage"),
"Arizona" => array("Phoenix","Tucson","Mesa","Chandler","Glendale","Scottsdale","Gilbert","Tempe","Peoria","Surprise"),
"Arkansas" => array("Little Rock"),
"California" => array("Los Angeles","San Diego","San Jose","San Francisco","Fresno","Sacramento","Long Beach","Oakland","Bakersfield","Anaheim","Santa Ana","Riverside",
                      "Stockton","Chula Vista","Fremont","Irvine","San Bernardino","Modesto","Oxnard","Fontana","Moreno Valley",
                       "Glendale","Huntington Beach","Santa Clarita","Garden Grove","Santa Rosa","Oceanside","Rancho Cucamonga","Ontario","Lancaster",
                        ...
                        "Temecula"),
"Carolina del Norte" => array("Charlotte","Raleigh","Greensboro","Winston-Salem","Durham","Fayetteville","Cary","Wilmington","High Point"),
"Carolina del Sur" => array("Columbia","Charleston"),
"Colorado" => array("Denver","Colorado Springs","Aurora","Fort Collins","Lakewood","Thornton","Pueblo","Arvada","Westminster","Centennial"),
"Connecticut" => array("Bridgeport","New Haven","Hartford","Stamford","Waterbury"),
"Dakota del Norte" => array("Fargo"),
"Dakota del Sur" => array("Sioux Falls"),
"Delaware" => array("Bellefonte","Bridgeville","Camden","Claymont","Clayton","Delaware City","Delmar","Dover Base Housing","Edgemoor","Elsmere",
...
"Distrito de Columbia" => array("Washington"),
"Florida" => array("Jacksonville","Miami","Tampa","San Petersburgo","Orlando","Hialeah","Tallahassee","Fort Lauderdale","Port St. Lucie","Pembroke Pines","Cape Coral","Hollywood","Gainesville","Miramar","Coral Springs","Clearwater","Miami Gardens","Palm Bay"),
"Georgia" => array("Atlanta","Augusta","Columbus","Savannah","Athens"),
"Hawai" => array("Honolulu"),
"Idaho" => array("Boise"),
"Illinois" => array("Chicago","Aurora","Rockford","Joliet","Naperville","Springfield","Peoria","Elgin"),
"Indiana" => array("Indianapolis","Fort Wayne","Evansville","South Bend"),
"Iowa" => array("Des Moines","Cedar Rapids"),
"Kansas" => array("Wichita","Overland Park","Kansas City","Topeka","Olathe"),
"Kentucky" => array("Louisville","Lexington"),
"Luisiana" => array("Nueva Orleans","Baton Rouge","Shreveport","Metairie","Lafayette"),
"Maine" => array("Portland", "Lewiston", "Bangor", "South Portland", "Auburn", "Brunswick", 
...
"Maryland" => array("Baltimore"),
"Massachusetts" => array("Boston","Worcester","Springfield","Lowell","Cambridge"),
"Michigan" => array("Detroit","Grand Rapids","Warren","Sterling Heights","Ann Arbor","Lansing","Flint"),
"Minnesota" => array("Mineapolis","St Paul","Rochester"),
"Misisipi" => array("Jackson"),
"Misuri" => array("Kansas City (Misuri)","San Luis","Springfield","Independence","Columbia"),
"Montana" => array("Billings"),
"Nebraska" => array("Omaha","Lincoln"),
"Nevada"=> array("Las Vegas","Henderson","Reno","Paradise","North Las Vegas"),
"Nueva Jersey" => array("Newark","Jersey City","Paterson","Elizabeth"),
"Nueva York" => array("Nueva York","Bufalo","Rochester","Yonkers","Siracusa"),
"Nuevo Hampshire" => array("Manchester"),
"Nuevo Mexico" => array("Albuquerque"),
"Ohio" => array("Columbus","Cleveland","Cincinnati","Toledo","Akron","Dayton"),
"Oklahoma" => array("Oklahoma City","Tulsa","Norman"),
"Oregon" => array("Portland","Eugene","Salem","Gresham"),
"Pensilvania" => array("Filadelfia","Pittsburgh","Allentown","Erie"),
"Rhode Island" => array("Providence"),
"Tennessee" => array("Memphis","Nashville","Knoxville","Chattanooga","Clarksville","Murfreesboro"),
"Texas" => array("Houston","San Antonio","Dallas","Austin","Fort Worth","El Paso","Arlington","Corpus Christi","Plano","Laredo","Lubbock","Garland",
...
"Vermont" => array("Burlington", "Essex", "South Burlington", "Colchester", "Bennington", 
...
"Virginia" => array("Virginia Beach","Norfolk","Chesapeake","Arlington","Richmond","Newport News","Alexandria","Hampton"),
"Virginia Occidental" => array("Charleston", "Huntington", "Parkersburg", "Wheeling", "Morgantown", "Weirton", 
...
"Washington" => array("Seattle","Spokane","Tacoma","Vancouver","Bellevue","Everett"),
"Wisconsin" => array("Milwaukee","Madison","Green Bay"),
"Wyoming" => array("Cheyenne", "Casper", "Laramie", "Gillette", "Rock Springs", "Sheridan", 

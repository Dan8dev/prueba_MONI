  ...
  <body>
    ...
    <div class="br-sideleft overflow-y-auto">
      <div class="br-sideleft-menu">
        ...
        <a href="talleres.php" class="br-menu-link">
          <div class="br-menu-item">
            <i class="menu-item-icon fa fa-calendar tx-22"></i>
            <span class="menu-item-label">XXIV Congreso</span>
          </div>
        </a>
        ...
        <a href="ayuda.php" class="br-menu-link">
          <div class="br-menu-item">
        ...
        <!--<a href="talleres.php" class="br-menu-link">
          <div class="br-menu-item">
            <i class="menu-item-icon fa fa-briefcase tx-19"></i>
            <span class="menu-item-label">Talleres</span>
          </div>
        </a>-->

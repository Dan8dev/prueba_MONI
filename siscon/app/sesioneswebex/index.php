<?php
    ...
    if(isset($_SESSION["alumno"]) || isset($_GET['android_id_afiliado']))
    {
        ...
        <form id="IDForm" method="POST">
            ...
            <input type="hidden" name="BU" value="https://conacon.org/moni/siscon/app/claseswebex/respuestawebex.php?sesion=<?php echo $_GET['sesion']; ?>&android_id_afiliado=<?php echo $idusuario; ?>" />
        </form>
        <script>

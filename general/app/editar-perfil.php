            ...
            <div class="col-sm-12 col-lg-4">
              <div class="card mg-b-40">
                ...
                <?php 
        				...
        				?>
                <img id="imagenperfil" class="card-img-bottom img-fluid" src="<?php echo $foto; ?>" alt="Image">
              </div>
            </div>
          </div> 
          ...
          <div id="wizard2">
            ...
            <section>
              ...
              <div class="form-group wd-xs-300 d-none">
                ...
                <input id="codigopostal" class="form-control" name="codigopostal" placeholder="Ingresa C.P." type="number" required maxlength="5">
              </div><!-- form-group --> 
              <div class="form-group wd-xs-300">
              ...
              <div class="form-group wd-xs-300">
                ...
                <input id="celular" class="form-control" name="celular" placeholder="Ingresa número de celular" type="number" required maxlength="11">
              </div><!-- form-group -->
              <div class="form-group wd-xs-300 d-none">
                <label class="form-control-label">Facebook: <span class="tx-danger">*</span></label>
                <input id="facebook" class="form-control" name="facebook" placeholder="Ingresa liga a facebook" type="text" required>
              </div><!-- form-group -->
              <div class="form-group wd-xs-300 d-none">
          ...
          <div class="modal-body" >
            <form id="form_editar_grado">
              ...
              <div class="form-group wd-xs-300">
                ...
                <input id="tipoLicen_edit" class="form-control" name="tipoLicen_edit" placeholder="Ingresa Tipo Licenciatura" onkeyup="mayusculas(this);" type="text" >
              </div>
              <div class="form-group wd-xs-300">
                <label class="form-control-label">Cédula Profesional: <span class="tx-danger">*En caso de contar con ella</span></label>
                <input id="cedulap_edit" class="form-control" name="cedulap_edit" placeholder="Ingresa Cédula profesional" onkeyup="mayusculas(this);" maxlength="8" type="text" >
              </div>
            </form>
          </div>

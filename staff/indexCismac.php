<?php 
	...
	$evtM = new Evento();
	$id_evento = 76; //cambiar este id para el evento
...
<head>
	...
	<!-- CSS bootstrap -->
	<link href="../assets/css/bracket.css" rel="stylesheet" type="text/css">
	<!-- iconos fontawesom -->
...
<body>
		...
		<header id="topnav">
			...
			<div class="navbar-custom" id="content-lines">
				<div class="container-fluid">
					<div id="navigation">
						<!-- Navigation Menu-->
						<ul class="navigation-menu tx-teal">
	...
	<div class="wrapper  tx-conacon">
		<div class="container-fluid">
			<!-- Page-Title -->
			<center>
				<img id="fotoasistente" class="img-top img-fluid w-25 img-radius-25"   src="../assets/images/generales/flyers/cismac_.png" >
			</center>
			<?php if ($info_t !== false): ?>
				<div class="text-center pt-4">
					<h1 class=" tx-conacon">ACCESO PARA: <b><?php echo $info_t['data']['nombre']; ?></b></h1>
				</div>
			<?php else: ?>
				<div class="text-center pt-4">
					<h1 class="tx-conacon">ACCESO GENERAL</h1><h2 class=" tx-conacon"><?= $info_e['data']['titulo'] ?></h2>
				</div>
			<?php endif; ?>
			<div class="row">
				<div class="col-sm-12">
				...
				<div class="col-sm-12 col-lg-6">
					<div class="card align-items-center">
						<div class="card-body">
							...
							<center>
								<img id="fotoasistente" class="img-top img-fluid"   src="../assets/images/generales/flyers/precongreso_logoterapia.jpg" style="width: 80%;">
							</center>
						</div>
					</div>
				</div>

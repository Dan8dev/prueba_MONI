						...
						switch($Consulta['data'][0]['estatus']){
							...
							case '2':
								...
								$data[]=array(
									...
									2=> '<div class ="row"><div class = "col-sm-6">'.$dato->nombre.'</div><div class = "col-sm-6"><a href="../../assets/files/servicio/alumnos/'.$nombreDoc.'"><h6 class="text-primary"> Visualizar</h6><div></a><div></div>',

      ...
      reader.onloadend = function () {
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            send_copy = (window.location.toString().includes('sandbox.conacon.org') ? '../../udc/app/data/CData/afiliadosControl.php' : 'https://moni.com.mx/udc/app/data/CData/afiliadosControl.php' );
            $.ajax({
              url: send_copy,
              method: 'POST',

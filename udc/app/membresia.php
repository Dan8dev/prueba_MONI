              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card card-body rounded-0">
                  ...
                  <h2 class="tx-inverse tx-bold tx-lato">
                    <span>
                    <?php if ($tipodemembresia==6||$tipodemembresia==7||$tipodemembresia==4||$tipodemembresia==9||$tipodemembresia==12||$tipodemembresia==17||$tipodemembresia==18||$tipodemembresia==20) {
                                echo 'ANUAL';
                          } 
                          if ($tipodemembresia==8) {
                            echo 'GRATIS';
                          }
                          if ($tipodemembresia==3 || $tipodemembresia==13|| $tipodemembresia==22) {
                            echo 'SEMESTRAL';
                          }
                    ?>
                  </span>

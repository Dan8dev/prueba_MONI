...
if(!isset($_SERVER["HTTPS"]) || $_SERVER["HTTPS"] != "on")
{
  ...
  session_start();
  if (!isset($_SESSION["alumno_iesm"])) {
    header('Location: signin-simple.html');
    die();
  }
  $usr = $_SESSION["alumno_iesm"];
?>
<!DOCTYPE html>
<html lang="en">
  <head>
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="documents/EFP/<?php echo $usr["foto"]; ?>" class="wd-32 rounded-circle" alt=""> 
   ...
   <div class="br-sideright">
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Formación Académica</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Reconocimientos</h4>
        <p class="mg-b-0">Da de alta tus Cursos, Diplomados, Certificaciones, Talleres.</p>
      </div>

      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Registrar</h6>
          <p class="mg-b-40 tx-gray-600">Esta información formará parte de tu perfil publico</p>

          <div id="wizard1">
            <h3>Agregar reconocimiento</h3>
            <section>
            <div class="form-layout form-layout-1">
              <div class="row">
                <div class="col-lg-4 col-sm-12 col-xsm-12 col-md-6">
                  <div class="card mg-b-40">
                    <div class="card-body">
                      <p class="card-text">Foto reconocimiento</p>
                      <form method="post" id="form-enviar-foto-reconociemiento" enctype="multipart/form-data">
                        <label class="custom-file">
                        <input id="subirfotoreconocimiento" type="file" name="file" class="custom-file-input">
                        <input type="hidden" name="action" value='enviarfotoreconocimiento'>
                        <span class="custom-file-control custom-file-control-primary"></span>
                        </label>
                      </form>
                    </div>
                    <img id="imagenreconocimiento" class="card-img-bottom img-fluid" src="../img/img12.jpg" alt="Image">
                  </div>
                </div>
              </div> 
              <div class="row mg-b-25">
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="firstname"  placeholder="Nombre de Curso, Taller, Diplomado">
                  </div>
                </div><!-- col-4 -->
                <div class="col-lg-3">
                ...
                <div class="col-lg-3">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="firstname"  placeholder="Fecha del Curso, Taller, Diplomado...">
                  </div>
                </div><!-- col-3 -->
                <div class="col-lg-3">
                  <div class="form-group">
                    <label class="form-control-label">Folio: <span class="tx-danger">*</span></label>
                    <input class="form-control" type="text" name="lastname" placeholder="Ingresa el número de folio ó clave de tu diploma / reconocimiento">
                  </div>
                </div><!-- col-3 -->
              </div><!-- row -->
              <div class="form-layout-footer">
                <button class="btn btn-info mg-b-10">Guardar</button>
                <button class="btn btn-secondary mg-b-10">Cancelar</button>
              </div><!-- form-layout-footer -->
            </div><!-- form-layout -->
            </section>
            <h3>Listado de reconocimientos</h3>
            <section>
    ...
    <script src="script/formacion-academica.js"></script>
    <script>

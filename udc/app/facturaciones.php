          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <form id="form-billing">
                ...
                <div class="form-group hidden" id="ConsFis">
                  <p class="d-inline-block">Ejemplo de constancia fiscal</p>
                  <button type="button" id="viewer" class="btn-plus rounded-circle d-inline-block"> <img src="img/pregunta.png" > </button>
                  <p>Sube tu constancia fiscal</p>
				...
				<div class="modal-dialog modal-xl" role="document">
					<div class="modal-content">
							<div class="modal-header">
									<h5 class="modal-title">Ejemplo de constancia fiscal</h5>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
										</button>
								</div>
                  <div class="modal-body">
                    <img class="img-fluid" src="img/ejemplodeconstancia.jpeg" > 
                  </div>

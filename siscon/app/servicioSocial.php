                    ...
                    <div class="tab-pane fade" id="photos">
                        <div class="row">
                            <div class="col-sm-12 overflow-auto">
                                ...
                                <center><b>Recuerda Enviar tus formatos en el orden indicado, de lo contrario control escolar no validará tus documentos</b></center>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <div class="container-fluid">
                                        <div class="card-body">
                                            <table id="tablaComentariosArchivo"  class="table table-striped table-bordered nowrap" style="overflow:auto; display: block; width: 100%;">
                                                <thead>
                                                    <th>Comentarios</th>
                                                    <th>Fecha</th>
                                                </thead>

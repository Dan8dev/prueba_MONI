...
// $pdf->Output();
require_once 'correos_prospectos.php';
...
if($plantilla != ''){
    echo json_encode(enviar_correo_registro('Envío de plan de pago', $destintatarios, $plantilla, $claves, $valores, $filename));
}

// var_dump(sendEmailOwn($destintatarios,'Envío de plan de pago', "<h1>Saludos</h1>", "none", $filename));
?>

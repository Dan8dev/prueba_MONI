        ...
        <div class="wrapper-page">
            <div class="card card-pages">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal m-t-20" id="formCambioPass">
                        <input type="hidden" id="directorio" name="directorio" value="<?= $usuario['directorio'] ?>">
                        <div class="form-group">
                            <div class="col-12">
                                <label for="">Escriba su contraseña actual</label>
                                <input class="form-control" type="password" required="" name="current_pass" id="current_pass" placeholder="*******">
                            </div>
                        </div>

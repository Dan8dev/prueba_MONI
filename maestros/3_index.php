    ...
    <body>
                              ...
                              <table id="listado_prospectos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; width: 100%;">
                                ...
                                if( $resultado->num_rows > 0 ){?>
                                  <?php while( $fila = $resultado->fetch_assoc() ){?>
                                    ...
                                    <a class="btn btn-secondary waves-effect waves-light" href="eliminarTarea.php?idTarea=<?=$fila['idTareas']?>">Eliminar</a></td>
                                  </tr>
                                    <?php }?>
                                <?php } ?>                               
                              ...
                              <table id="listado_prospectos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; width: 100%;">
                                ...
                                if( $resultado->num_rows > 0 ){?>
                                  <?php while( $fila = $resultado->fetch_assoc() ){?>
                                    ...
                                    <a class="btn btn-secondary waves-effect waves-light" href="eliminarClase.php?idClase=<?=$fila['idClase']?>">Eliminar</a></td>
                                  </tr>
                                    <?php }?>
                                <?php } ?>                               
                        ...
                        <div class="row tab-pane fade" id="agregarclase" role="tabpanel" aria-labelledby="profile-tab">
                          <div class="table-responsive">
                            ...
                            <form name="form1" class="form-horizontal" method="post" action="agregarClase.php?idMaestro=<?=$usuario['idPersona']?>">
                              ...
                              <button type="button" class="btn btn-secondary" id="btn-minus" onClick="quitarRecursos();">Quitar todos los recursos</button><br>
                            <!-- FIN AGREGAR RECURSO-->
                            <hr>
      ...
      <script>
          ...
          if($("#name_li").val() != '' && $("#enlace_li").val() != ''){
            ...
            uls = "";
              for (i = 0; i < list_enlaces.length; i++) {
                uls+=`<li><a href="${list_enlaces[i][0]}" target="_blank">${list_enlaces[i][1]}</a></li>`;
              }
        ...
        function quitarRecursos(){
            ...
            var top = document.getElementById("list_recursos");

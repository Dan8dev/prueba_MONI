...
$("#generar_ficha_pago").on('click', function(){
	var monto_f = (parseFloat($('#monto_a_pagar').text().replace(/\$|,/g, "")) || 0) + (parseFloat($("#monto_con_recargo").text().replace(/\$|,/g, "") || 0));
	if(monto_f < 16) {
...
$("#generar_ficha_pago_spei").on('click', function(){
	var monto_f = parseFloat($('#monto_a_pagar').text().replace(/\$|,/g, "")) + (parseFloat($("#monto_con_recargo").text().replace(/\$|,/g, "") || 0));
	if(monto_f < 16) {

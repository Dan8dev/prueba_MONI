...
$idusuario=isset($android_id_afiliado) ? $android_id_afiliado : $_SESSION['alumno']['id_afiliado'];
...
switch ($accion) {
    ...
    case 'subirFotoPerfil':
        ...
        case 'obtenerestado':
            ...
            $rspta4=$afiliados->obtenerestados($_POST);
...
if(!isset($_SESSION['alumno']) && !$android_id_afiliado && (!isset($_POST['action']) || !isset($_GET['op']))){

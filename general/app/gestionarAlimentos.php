    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Gestionar Alimentos</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
      
        <h4 class="tx-gray-800 mg-b-5">Cupones de alimentos</h4>
      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">         
            ...
            <p class="mg-b-25 mg-lg-b-50">Realizada tu selección se genera un código QR que deberas scanear en el área de alimentos.</p>
                ...
                <form id="form_alimentos">
                  ...
                  <div class="form-layout-footer">
                    <button class="btn btn-info">Generar QR</button>

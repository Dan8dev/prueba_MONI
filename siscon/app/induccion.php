...
if (!isset($_SESSION["alumno"])) {
  ...
  $registro_evento = $porospM->validar_registro_evento($_SESSION['alumno']['id_prospecto'], 40);

  $contenQr = '';
  if($registro_evento[0]){
    $contenQr = $_SESSION['alumno']['id_prospecto'].'-40';
  }
?>
...
<div class="br-mainpanel">
  <div class="br-pageheader pd-y-15 pd-l-20">
    <nav class="breadcrumb pd-0 mg-0 tx-12">
      ...
      <span class="breadcrumb-item active">TALLER</span>
    </nav>
  </div><!-- br-pageheader -->
  ...
  <div class="br-pagebody">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
      <div class="py-0">
        <h4 class="tx-gray-800 mg-b-5">INDUCCIÓN A OPERADOR TERAPÉUTICO EN SALUD MENTAL Y ADICCIONES</h4>
        <div class="col-sm-12 mb-4">
          <div class="card bd-0">
            <div class="card-body bd bd-b-0 bd-color-gray-lighter rounded-top pb-2 bg-primary">
              <h6 class="mg-b-3 text-white mb-10">Inducción a operador terapéutico en salud mental y adicciones</h6>
              <a href="#" onclick="registrar_a_evento('induccion-a-operador-terapeutico-en-salud-mental')" class="btn btn-block btn-primary active btn-with-icon">
                <div class="ht-40 justify-content-between">
                 ...
                 <span class="icon wd-40"><i class="fa fa-globe"></i></span>
  					...
  					<img class="card-img-bottom img-fluid" src="https://moni.com.mx/assets/images/generales/flyers/fondoEvento2100985679.png" alt="Image">
          </div>
        </div>
      </div>

...
<meta charset="utf-8" />
    ...
    <link href="../siscon/lib/SpinKit/spinkit.css" rel="stylesheet">
								...
								<div class="tab-pane fade" id="calificaciones" role="tabpanel" aria-labelledby="calificaciones-tab">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
										...
										<!--<li class="nav-item">
                                            <a class="nav-link" id="Certificaciones-tab" data-toggle="tab" href="#Certificaciones" role="tab" aria-controls="Certificaciones" aria-selected="true">
                                                ...
                                                <span class="d-none d-sm-block"><i class="fa fa-medal"></i> Certificaciones estatales</span>
                                            </a>
                                        </li>-->
                                    ...
                                    <div class="tab-content bg-light">
										...
										<div class="tab-pane fade" id="Certificaciones" role="tabpanel" aria-labelledby="Certificaciones-tab">
											<h2>Certificaciones Estatales</h2>
											<div class="col-12 row">
												<div class="col-sm-12 col-md-6">
													<label for="carrerasCalificacionesCertificaciones">Selecciona una carrera</label>
													<select id="carrerasCalificacionesCertificaciones" class="form-control">
														<option disabled selected>Seleccione una carrera</option>
													</select>
												</div>
							
												<div class="col-sm-12 col-md-6">
													<label for="generacionesCalificacionesCertificaciones">Selecciona una generación</label>
													<select id="generacionesCalificacionesCertificaciones" class="form-control">
														<option disabled selected>Seleccione una generación</option>
													</select>
												</div>
											</div>
											...
											<div class="card-body">
												...
												<form id="formBlogs">
													...
													<div class="imgpreviewC" style="background-image:url('../assets/images/generales/flyers/default.png');"></div>
														<p class="mb-0">Please use .jpg or .png with non-transparent background.</p>
													...
													<div class="form-group">
														<select id="class" class="form-control hidden"></select>
									...
									<div class="form-group row">
										<div class="col">
											<div class="">
												...
												<input type="text" name="inp_porcentaje_aprobar_i" class="form-control inp_porcentaje_aprobar onlyNum" placeholder="1 - 100">
											</div>
										</div>
									</div>

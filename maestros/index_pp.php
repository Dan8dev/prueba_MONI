                      ...
                      <div class="tab-content bg-light">
                        ...
                        <div class="row tab-pane fade" id="agregarExamen" role="tabpanel" aria-labelledby="profile-tab">
                          <div class="table-responsive">
                            ...
                            <form name="form1" class="form-horizontal" method="post" action="agregarExamen.php?idMaestro=<?=$usuario['idPersona']?>">
                              ...
                              <p>Curso al que pertenecerá el examen:
                              <select class="form-control" name="idCurso">
                              <?php 
                                if( $resultado->num_rows > 0 ){?>
                                  <?php while( $fila = $resultado->fetch_assoc() ){?>
                              ...
                              Rango de fechas en las que el alumno podrá presentar el examen:                                  
                            ...
                            <div id="p<?=$i?>" <?php if( $i == 1 || $i == 2 ) echo 'style="display:block"'; else echo 'style="display:none"' ?>><!--Pregunta <?=$i?>-->
                              ...
                              <label> 
                                      <input name="Opcion<?=$i?>" type="radio" value="A" title="Marcar ésta opción como la correcta" checked>
                                      <input name="TextoOpcion<?=$i?>_A" type="text" placeholder="Opción A..." id="example-text-input" style="border-color: transparent;"> 
                              </label>
                              <label> <input name="Opcion<?=$i?>" type="radio" value="B" title="Marcar ésta opción como la correcta">
                                      <input name="TextoOpcion<?=$i?>_B" type="text" placeholder="Opción B..." id="example-text-input" style="border-color: transparent;">
                              </label>
                              <label> <input name="Opcion<?=$i?>" type="radio" value="C" title="Marcar ésta opción como la correcta">
                                      <input name="TextoOpcion<?=$i?>_C" type="text" placeholder="Opción C..." id="example-text-input" style="border-color: transparent;">
                              </label>
                              <label> <input name="Opcion<?=$i?>" type="radio" value="D" title="Marcar ésta opción como la correcta">
                                      <input name="TextoOpcion<?=$i?>_D" type="text" placeholder="Opción D..." id="example-text-input" style="border-color: transparent;">
                              </label>
                            </div>
                            <?php } //Fin for?>
                        ...
                        <div class="row tab-pane fade <?php if( isset( $_GET['p'] ) && $_GET['p'] == "editarExamen" || $_GET['p'] == 'aeo' ) echo "show active"; ?>" id="listadoExamen" role="tabpanel" aria-labelledby="profile-tab">
                          <div class="table-responsive">
                            ...
                            <div id="pe<?=$i?>"><!--Pregunta <?=$i?>-->
                              ...
                              <?php
                                ...
                                foreach ($respuestas as $clave => $valor) {?>
                                    <!--//echo "{$clave} => {$valor} ";-->
                                    <input name="Opcion<?=$i?>" type="radio" value="<?=$op[$j]?>" title="Marcar ésta opción como la correcta" <?php if( $valor == 1 ) echo "checked"; ?>>
                            ...
                            <h4>Pregunta <?=$i?>:</h4> <input name="pregunta<?=$i?>" type="text" class="form-control" placeholder="Escriba la pregunta <?=$i?>..." id="example-text-input"><br>
                              <label> <input name="Opcion<?=$i?>" type="radio" value="A" title="Marcar ésta opción como la correcta" checked>
                                      <input name="TextoOpcion<?=$i?>_A" type="text" placeholder="Opción A..." id="example-text-input" style="border-color: transparent;">
                              </label>
                              <label> <input name="Opcion<?=$i?>" type="radio" value="B" title="Marcar ésta opción como la correcta">
                                      <input name="TextoOpcion<?=$i?>_B" type="text" placeholder="Opción B..." id="example-text-input" style="border-color: transparent;">

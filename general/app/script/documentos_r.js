...
$.ajax({
    ...
    success: function(data){
        try{
            ...
            if($idDoc == 1){
                $("#verImg").hide();
                var $dir = '../app/lista_documentos/Identificaciones/'+$name;
                canvas($dir);
                $("#pdf_renderer").show();
            ...
            if($idDoc == 2){
                $("#verImg").hide();
                var $dir = '../app/lista_documentos/Actas_nacimiento/'+$name;
                canvas($dir);
                $("#pdf_renderer").show();
            ...
            if($idDoc == 3){
                $("#verImg").hide();
                var $dir = '../app/lista_documentos/Curp/'+$name;
                canvas($dir);
            ...
            if($idDoc == 4){
                $("#verImg").hide();
                var $dir = '../app/lista_documentos/Comprobante_estudios/'+$name;
                canvas($dir);
                $("#pdf_renderer").show();
            ...
            if($idDoc == 5){
                $("#pdf_renderer").hide();
                //$("#verDoc").hide();
                $("#verImg").attr('src','../app/lista_documentos/Fotos_ovalo/'+$name);
                //$("#nom").val($name);
                $("#comentario").val($com);
                $("#idDocument").val($idDoc);
                $("#verImg").show();
            ...
            if($idDoc == 6){
                $("#pdf_renderer").hide();
                //$("#verDoc").hide();
                $("#verImg").attr('src','../app/lista_documentos/Fotos_infantil/'+$name);
                //$("#nom").val($name);
                //$("#pdf_renderer").hide();
                $("#comentario").val($com);
                $("#idDocument").val($idDoc);

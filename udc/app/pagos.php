            ...
            <div class="row">
              ...
              <div class="col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <input id="nombretarjeta" type="text" placeholder="Nombre del titular de la tarjeta" class="form-control cc-nombre normalText" name="nombretarjeta" data-conekta="card[name]" autocomplete="off">
                </div>
              </div>
              <div class="col-sm-12">
                <div class="form-group">
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  <label>Tarjeta</label>
                  <input type="text" placeholder="16 dígitos" class="form-control cc-num" data-conekta="card[number]" autocomplete="off">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label>CVC</label>
                  <input type="text" placeholder="123" class="form-control cc-cvc" maxlength="4" data-conekta="card[cvc]" autocomplete="off">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tx-size-sm">
          ...
          <div class="modal-body pd-20">
            ...
            <form class="mx-2" id="form_registrar_pago_alumno">

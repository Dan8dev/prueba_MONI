...
if(!isset($_SERVER["HTTPS"]) || $_SERVER["HTTPS"] != "on")
{
  ...
  $estatus_sesion = $webex->estatus_sesion(1);
?>
<!DOCTYPE html>
<html lang="en">
  <?php require 'plantilla/header.php'; ?>
        ...
        <?php if($_GET['curso'] == 2): ?>
		  <!--<div class="alert alert-primary" role="alert">
			<strong class="d-block d-sm-inline-block-force">Recordatorio!</strong> 
				<ul class="mb-0">
					<li>
						<a href="#" class="text-primary" onclick='$($("#content-materias li")[8]).find("a").click();'>
							Examen Certificación CONOCER EC0585 (25-04-2022 17:00:00) - (25-04-2022 20:00:00).
						</a>
					</li>
          <li>
						<a href="#" class="text-primary" onclick='$($("#content-materias li")[9]).find("a").click();'>
							Examen Acreditación OTA (25-04-2022 17:00:00) - (25-04-2022 20:00:00).
						</a>
					</li>
				</ul>
          </div>-->
    ...
    <?php if($estatus_sesion['data']['estatus']==1): ?>
        <!-- <a href="claseswebex/?clase=11&carrera=2" style="color: #4479ab;text-decoration: underline;"><h2>Clic aquí para entrar a tu clase en vivo</h2></a> -->
      <?php endif; ?>
	<a href="https://educat-platform.mykajabi.com/login" target="_blank" style="color: #c61200;text-decoration: underline;"><h2>Clic aquí para entrar a tu plataforma EDUCAT.</h2></a>
            ...
            <div class="col-sm-12 col-md-3">
              <section id="section_video_d" style="display:none">
                ...
                <div class="card mg-b-40">
                    <img class="card-img-bottom img-fluid" id="image-clase" src="https://conacon.org/moni/siscon/app/img/ItunesArtwork@2x.png" alt="Image">
        ...
        <div class="br-section-wrapper pt-0" id="content-calificaciones-materias" style="display:none">
          <h1 id="mostrar-letrero-calif" class="pt-4 mb-4">Calificaciones</h1>

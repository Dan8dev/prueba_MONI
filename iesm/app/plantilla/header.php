...
$contactos = $nAfiliado->consultar_directorio_institucion(19);
$carreras_asign = $nAfiliado->cunsultar_si_generacion_institucion($usuario['data']['idAsistente'], 19);
//echo $d;
$p = [];
...
<head>
    ...
    <!-- Meta -->
    <meta name="description" content="Instituto de Estudios Superiores en Medicina">
    <meta name="author" content="Instituto de Estudios Superiores en Medicina Desarrollo Tecnológico">

    <title>Instituto de Estudios Superiores en Medicina</title>
      ...
      // if($d['data'] == 1){
        ...
        for($i=0 ; $i < count($vis) ; $i++){
          if(in_array($vis[$i]['idVista'], $p) && !in_array($vis[$i]['idVista'],$excluir)){
            $item = '<a href="'.$vis[$i]['directorio'].'.php" class="br-menu-link"><div class="br-menu-item"><img src="../../udc/app/img/icons/'.$vis[$i]['icono'].'.svg"><span class="menu-item-label">'.$vis[$i]['nombre'].'</span></div></a>';

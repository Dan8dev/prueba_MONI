                                            ...
                                            <form class="w-100" id="formRegisterClinicToEvent">
                                                <input type="hidden" name="nombre_clave_destino" value="<?php echo($_GET['e']); ?>">
                                                    ...
                                                    <div class="row mrg20">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                                            <input class="w-100 name" type="text" name="name_clinica_cl" placeholder="Nombre de la clínica o centro" required>
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-lg-12 pl-4 pb-4 mt-2 border-bottom">
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <input class="form-check-input" type="radio" name="flexRadioDefaultPacientes" value="1"  checked="true" id="atencionSustancias">
                                                                    <label class="form-check-label" for="atencionSustancias">Problemas de abuso de sustancias</label>
                                                                </div>
                                                                <div class="col">
                                                                    <input class="form-check-input" type="radio" name="flexRadioDefaultPacientes" value="2" id="atencionAlcohol">
                                                                    <label class="form-check-label" for="atencionAlcohol">Problemas de abuso de alcohol</label>
                                                                </div>
                                                                <div class="col">
                                                                    <input class="form-check-input" type="radio" name="flexRadioDefaultPacientes" value="3" id="atencionOtro">

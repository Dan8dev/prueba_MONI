    ...
    $.ajax({
        ...
        success : function(data){
            try{
                ...
                if(pr.validacion == undefined || pr.validacion == null || pr.validacion == '' ){
                    swal({
                        title: 'Aún no se cargado la fotografia infantil.',
                        icon: 'info',
                        text: 'Favor de subirla en documentación y esperar respuesta de control escolar.',
                        button: false,
                        timer: 4000,
                    });
                }
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                html_c=`<div class="col-sm-6 col-md-6 col-xl-4">
                    ...
                    if(mensaje != ''){
                        $("#cursos-container").append(`<div class="alert alert-bordered alert-warning text-dark" style="max-height: 100px;" role="alert">
                            <strong class="d-block d-sm-inline-block-force text-dark"></strong> ${mensaje}.
                        </div>`);
                    }
                }
            }

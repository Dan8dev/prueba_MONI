...
$(document).ready(()=>{
    ...
    $('#materias_asignacion').on('change','#Smaterias',function(){
        $('#nombre_clase').val($('option:selected', this).text());
    });
...
function tableSessions(){
    ...
    tableSession = $("#table-sessions").DataTable({
        ...
        buttons:[{
            extend: "excel",
            className: "btn-primary",
            title: "Clases_"+new Date().toLocaleDateString().replace(/\//g, '-'),
            exportOptions: {
...
function tablaMateriasReportes(idCiclo,idAlumno,idGen,idCarr){
    suf_carr = $("#carrerasCalificacionesReporte option:selected").text();
    suf_gen = 'G'+$("#generacionesCalificacionesReporte option:selected").text().split(' ')[1];
    ...
    sesionesenvivo = $("#TableCalReporteSemestre").DataTable({
        ...
        buttons:[{
            extend: "excel",
            title: `Calificaciones_ciclo_${suf_carr}_${suf_fecha}_${suf_gen}_${suf_alum}`,
            className: "btn-primary"
        }, {
            extend: "pdf",
            title: `Calificaciones_ciclo_${suf_carr}_${suf_fecha}_${suf_gen}_${suf_alum}`
...
function tablaDirectorio(Band, reloadSelects = true){
    $.ajax({
        url:'../assets/data/Controller/controlescolar/controlescolarControl.php',
        type:'POST',
        data:{
        ...
        success: function (data){
            ...
            try{
                ...
                for(a in alumnos){
                    ...
                    string_tel = '';
                    if(telefono != ''){
                        string_tel = telefono != celular && celular != '' ? `<li class="list-item"><i class="fa fa-mobile" title="Teléfono particular"></i> <a href="tel:${telefono}">${telefono}</a> / <a href="tel:${celular}">${celular}</a></li>` : `<li class="list-item" title="Teléfono particular"><i class="fa fa-mobile"></i> <a href="tel:${telefono}">${telefono}</a></li>`;
                    }
                    if(alumn.telefono_casa.replace(/[^0-9]+/g,'') != '' && alumn.telefono_casa.replace(/[^0-9]+/g,'') != telefono){
                        string_tel += `<li class="list-item"><i class="fa fa-home" title="Teléfono de casa"></i> <a href="tel:${alumn.telefono_casa.replace(/[^0-9]+/g,'')}">${alumn.telefono_casa.replace(/[^0-9]+/g,'')}</a></li>`;
                    }
                    if(alumn.telefono_recados.replace(/[^0-9]+/g,'') != '' && alumn.telefono_recados.replace(/[^0-9]+/g,'') != telefono){
                        string_tel += `<li class="list-item"><i class="fas fa-phone" title="Teléfono de recados"></i> <a href="tel:${alumn.telefono_recados.replace(/[^0-9]+/g,'')}">${alumn.telefono_recados.replace(/[^0-9]+/g,'')}</a></li>`;
                    }
                    ...
                    switch(alumn.estatusGen){
                        case '1':
                            ...
                            break;
                        case '2':
                            estatus = "<b class ='text-primary'>BAJA</b>";
                            break;
                        case '3':
                            estatus = "<b class ='text-success'>EGRESADO</b>";
                            break;
                        case '4':
                            estatus = "<b class ='text-success'>TITULADO</b>";
                            break;
                        case '5':
                            estatus = "<b class ='text-primary'>EXPULSADO</b>";
                            break;
                        case '6':
                            estatus = "<b class ='text-success'>EGRESADO</b>";
                            break;
                            case '7':
                            estatus = "<b class ='text-primary'>BLOQUEADO</b>";
                            break;
                        default:
                            estatus = "POR ASIGNAR";
                            break;
                    ...
                    if(Band !=2){
                        tabla_directorio.row.add([
                            ...
                            `<ul class="list-group" style="list-style: none;">${string_tel}</ul>`,
                ...
                selects_datatable('table_directorio', reloadSelects);
            }catch(e){
                console.log(e);
            }
        }
...
function tablaMaestros(){
    //:::Cambio
    tMaestros = $("#datatable-tablaMaestros").DataTable({
    responsive: true,
    Processing: true,
    ServerSide: true,
    "dom" :'Bfrtip',
    buttons:[{
        extend: "excel",
        className: "btn-primary",
        title: "Maestros_"+new Date().toLocaleDateString().replace(/\//g, '-'),
        exportOptions: {
            columns: [0,1,2],
        }
    }, {
...
(function () {
    var previous;
    $("#estatusAlumnoDirectorio").on('focus', function (){
        previous = this.value;
        }).change(function() {
            if(this.value == 5){
                Swal.fire({
                    title: '',
                    html:
                    'Al cambiar al estatus seleccionado y guardar cambios se <b>bloqueara el acceso del alumno a su Plataforma</b>',
                    type: 'warning',
                    ...
                    if(!result.value){
                        $("#estatusAlumnoDirectorio").val(previous)
                    }else{
                        $("#estatusAlumnoDirectorio").val(this.value)
                    }
                });
            }
        });
...
// var estatus = $("#estatusAlumnoDirectorio").val();
// $("#estatusAlumnoDirectorio").on("change",function(e){
//     if($("#estatusAlumnoDirectorio").val() == 2 || $("#estatusAlumnoDirectorio").val() == 5 || $("#estatusAlumnoDirectorio").val() == 7){
//         Swal.fire({
//             title: '',
//             html:
//             'Al cambiar el estatus se bloqueara el accesos del alumno a su Plataforma',
//             type: 'warning',
...
//         }).then((result)=>{
//             if(!result){
//                 $("#estatusAlumnoDirectorio").val(estatus)
//             }
//         });
//     }
// });
...
function tablaAlumnos(){
    ...
    suf_fecha = new Date().toLocaleDateString().replace(/\//g, '-');
    suf_gen = 'G'+$("#S_generacionesExpedientes option:selected").text().split(' ')[1];
    ...
    buttons:[{
        extend: "excel",
        className: "btn-primary",
        title:'Expedientes_'+$("#S_carrerasExpedientes option:selected").text()+'_'+suf_fecha+'_'+suf_gen
    }, {
        extend: "pdf",
        title:'Expedientes_'+$("#S_carrerasExpedientes option:selected").text()+'_'+suf_fecha+'_'+suf_gen,
            ...
            try{
                ...
                if(pr.estatus == 'ok'){
                    swal({
                        ...
                        $("#formMostrarMaestro")[0].reset();
                        tMaestros.ajax.reload(null,false);;
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            try{
                ...
                $('#materias_asignacion #Smaterias').change();
                $("#border-d").fadeIn();
...
$("#selectBuscarExamenesGeneracion").on('change', function(){
    ...
    suf_fecha = new Date().toLocaleDateString().replace(/\//g, '-');
    suf_gen = 'G'+$("#selectBuscarExamenesGeneracion option:selected").text().split(' ')[1];
    tExamenes = $("#datatable-tablaExamenes").DataTable({
        ...
        buttons:[{
            extend: "excel",
            className: "btn-primary",
            title:'Exámenes_'+$("#selectBuscarExamenesCarrera option:selected").text()+'_'+suf_fecha+'_'+suf_gen,
            exportOptions: {
                columns: [0,1,2,3,4],
            }
        }, {
...
function validarVistaDocumentos(id, idGeneracion, Nacionalidad){
    console.log("Dar tipo de alumno");
    $("#IdentificadorNacionalidad").val("Mexicano");
    if(Nacionalidad != 37 && Nacionalidad != 0){
        $("#IdentificadorNacionalidad").val("Extranjero");
    }
    //console.log(idGeneracion);
    $("#FormatHidden").removeClass('d-none');
    $('#ovaloT').addClass('d-none');
    $('#MsIDC').addClass('d-none');
    $('#udc4').removeClass('d-none');
    $('#udc23').addClass('d-none');
    $('#extnot').addClass('d-none');
    $.ajax({
        url: '../assets/data/Controller/controlescolar/controlescolarControl.php',
        type: 'POST',
        data: {
        ...
        success: function(data){
            try{
                ...
                console.log(pr.idInstitucion +" "+Nacionalidad+" "+pr.tipo);
                switch(pr.idInstitucion){
                    case '20':
                        if(pr.tipo == 2 || pr.tipo == 4){
                            $("#TipoAlumno").val('Universidad');
                            if(Nacionalidad != 37 && Nacionalidad != 0){
                                //$("#CartaMotivosOmitir").addClass("d-none");
                                CrearFormularioDinamico(2);
                                verificarDocExt(id);
                            }else{
                                CrearFormularioDinamico(2);
                                verificarDocExt(id);
                        ...
                        //if(pr.idGeneracion == 23 || pr.idGeneracion == 40 && pr.tipo == 7 || pr.tipo == 5){
                        if(pr.idCarrera  && pr.tipo == 7 || pr.tipo == 5){
                            $("#TipoAlumno").val('Medicina');
                           
                            if(Nacionalidad != 37 && Nacionalidad != 0){
                                //$("#Comprobante").addClass("d-none");
                                CrearFormularioDinamico(1);
                                verificarDocExt(id);
                            }else{
                                CrearFormularioDinamico(1);
                                verificarDocExt(id);
...
function verificarDocExt(idAlumno){

    $("#IdentificadorAlumno").val(idAlumno);
    VerificarBotonesEx();
    $("#ModalDocumentacionAlumnoExtranjero").modal("show");
   // $("#ModalDocumentacionAlumnoAdmin").modal("show");
}

$("#ModalDocumentacionAlumnoExtranjero").on("hidden.bs.modal", function () {
...
//                  5: ["#ButtonFotosCredencial","#FotosCredencial"],
//                  11:["#ButtonComprobante_Domicilio","#Comprobante_Domicilio"],
//                  21:["#ButtonCopiaTitulo","#CopiaTitulo"],
//                  22:["#ButtonDiplomaEspecialidad","#DiplomaEspecialidad"],
    ...
    $.ajax({
        ...
        success: function (response) {
            $.each(response, function(key,registro){
                ...
                <div class="form-group row justify-content-center `+registro.clases+`">
            ...
            $("#Formulario_dinamico").append(`<button type="submit" class ="btn btn-primary">Guardar Documentos</button>`);
        },
        complete: function(response){
...
function DocumentacionNacionalidad(Nacionalidad){
    ...
    switch(TipoAlumno){
        ...
        case "Medicina":
            ...
            break;
        case "Siscon":
            console.log("Mostrar solo los docuemntos que se piden para OTA");
            $(".NO-OTA").addClass("d-none");
            break;
    }
...
//                     }
//                     if(pr.data[i].id_documento == 19){
//                         $("#documentoUDC19").prop('disabled', true);
//                         $("#btnDocUDC19").prop('disabled', true);
//                         $("#btnDocUDC19").prop('disabled', true);
//                         $("#btnDocUDC19").hide();
//                         $("#btnEnviadoUDC19").show();
//                     }
//                     if(pr.data[i].id_documento == 21){
//                         $("#documentoUDC21").prop('disabled', true);
//                         $("#gradoEstudiosUDC21").prop('disabled', true);
//                         $("#btnDocUDC21").prop('disabled', true);
//                         $("#btnDocUDC21").prop('disabled', true);
//                         $("#btnDocUDC21").hide();
//                         $("#btnEnviadoUDC21").show();
//                     }
//                     if(pr.data[i].id_documento == 22){
//                         $("#documentoUDC22").prop('disabled', true);
//                         $("#gradoEstudiosUDC22").prop('disabled', true);
//                         $("#btnDocUDC22").prop('disabled', true);
//                         $("#btnDocUDC22").prop('disabled', true);
//                         $("#btnDocUDC22").hide();
//                         $("#btnEnviadoUDC22").show();
//                     }
//                     if(pr.data[i].id_documento == 23){
//                         $("#documentoUDC23").prop('disabled', true);
//                         $("#gradoEstudiosUDC23").prop('disabled', true);
//                         $("#btnDocUDC23").prop('disabled', true);
//                         $("#btnDocUDC23").prop('disabled', true);
//                         $("#btnDocUDC23").hide();
//                         $("#btnEnviadoUDC23").show();
//                     }
//                     if(pr.data[i].id_documento == 24){
//                         $("#documentoUDC24").prop('disabled', true);
//                         $("#gradoEstudiosUDC24").prop('disabled', true);
//                         $("#btnDocUDC24").prop('disabled', true);
//                         $("#btnDocUDC24").prop('disabled', true);
//                         $("#btnDocUDC24").hide();
//                         $("#btnEnviadoUDC24").show();
//                     }
//                 }
//             }catch(e){
//                 console.log(e)
...
function cargarTablaFormatos(id_proceso){
    ...
    tabladocservicio= $("#tabla-documentos-proceso").DataTable({
        ...
        buttons:[{
            extend: "excel",
            title:'Formatos_'+$("#formatosexistentes option:selected").text(),
            className: "btn-primary"
        }, {
            extend: "pdf",
            title:'Formatos_'+$("#formatosexistentes option:selected").text()
...
function ObtenerControlEscolar(){
    $.ajax({
        ...
        success: function(data){
            //console.log(data);
            $("#nombreUltimoAdmin").html('<option selected="true" value="" disabled="disabled">Sin Registros</option>');
            ...
            $.each(data, function(key,registro){
                ...
                $("#nombreUltimoAdmin").append('<option value='+registro.idAcceso+'>'+registro.nombres+'</option>');
                });
        }
    })
}
...
function registrarDocumentacion(idAlumno, idGeneracion, Pais){
    $("#idAlumnoDocumentacionFisica").val(idAlumno);
    $("#modalRegistrarDocumentosFisicos").modal('show');
    var letrero = " (Alumno Mexicano)";
    if(Pais != 37 && Pais != 0){
        letrero = " (Alumno Extranjero)";
    }
    $("#textoNacionalidad").text(letrero);
    ...
    // fechaAct = fechaAct.toISOString();
    // fechaAct = fechaAct.substr(0,10);
        ...
        success : function(data){
            try{
                ...
                if(pr.length != 0){
                    ...
                    fechaActual = pr[0].fechaActual.substr(0,10);
                    $("#fechaDocumentoFisico").val(fechaActual);  
                    $(`#nombreAdmin option:contains(${usrInfo.persona.nombres})`).attr('selected', true);
                    $("#fechaDocumentoFisico").attr('disabled', false);  
                    $(`#nombreAdmin`).attr('disabled', false);
                }else{
                    $("#fechaDocumentoFisico").attr('disabled', true);  
                    $(`#nombreAdmin`).attr('disabled', true);
                }
                //console.log(pr[0].fechaActual);
            }catch(e){
                console.log(e)
                console.log(data)
            }
    ...
    $.ajax({
        ...
        success: function(data){
            try{
                ...
                if(pr!=false){
                    // var fecha = pr.fecha_registro;
                    // fecha = fecha.substr(0,10);
                    //$("#nombreAdmin").val(pr.nombres);
                    // $("#fechaUltimoDocumentoFisico").val(fecha);
                    // $(`#nombreUltimoAdmin option:contains(${pr.nombres})`).attr('selected', true);
                    check="checked";
                }else{
                    check ='';
                }
                html_check_doc+=`<div class="form-group">
                                    <div class="row">
                                        ...
                                        ${pr.fecha_registro != "" && pr.fecha_registro != null && pr.fecha_registro != undefined  ?
                                            `<div class = "col-md-4">
                                                <a class="list-group-item list-group-item-action">
                                                    <b>${date = new Date(pr.fecha_registro).toLocaleString()}</b>
                                                </a>
                                            </div>` : ""}
                                    </div>
                                </div>`;
...
$("#carrera-servicio").on('change',function(){
    if(typeof(tablaAlumnosAsignados) != 'undefined'){
        tablaAlumnosAsignados.clear();
        tablaAlumnosAsignados.draw();
    }
...
$("#carrerasCalificacionesTitulados").on('change',function(){
    if(typeof(tablaAlumnosTitulados) != 'undefined'){
        tablaAlumnosTitulados.clear();
        tablaAlumnosTitulados.draw();
    }
...
$("#carrerasCalificacionesBoletas").on('change',function(){
    if(typeof(tCalificaciones) != 'undefined'){
        tCalificaciones.clear();
        tCalificaciones.draw();
    }
...
$("#carrerasCalificaciones_noAcre").on('change',function(){
    if(typeof(tCaficaciones) != 'undefined'){
        tCaficaciones.clear();
        tCaficaciones.draw();
    }
...
function tablaCredenciales(idAlumno){
    ...
    tablaSolicitudCred= $("#tablaHistorialCredenciales").DataTable({
        ...
        buttons:[{
            extend: "excel",
            className: "btn-primary",
            title: "Hist_Cred_"+new Date().toLocaleDateString().replace(/\//g, '-'),
...
function TablaCredenciales(){
    tablacredencialesnuevos= $("#datatable-tablaCredencialesAlumno").DataTable({
        ...
        buttons:[{
            extend: "excel",
            title: "Credenciales_"+new Date().toLocaleDateString().replace(/\//g, '-'),
            className: "btn-primary",
            exportOptions: {
                customizeData: function ( win ) {
                    var count = 0;
                    win.body.forEach(function(element){
                        Alumno = element[1];
                        fecha = element[2];
                        Alumno = Alumno.replace("MATRICULA","");
                        Alumno = Alumno.replace(/<b>/g,"");
                        Alumno = Alumno.replace(/<\/b>/g,"");
                        Alumno = Alumno.replace(/<br>/g,"");
    
                        fecha = fecha.replace("ESTATUS","");
                        fecha = fecha.replace(/<b>/g,"");
                        fecha = fecha.replace(/<\/b>/g,"");
                        fecha = fecha.replace(/<br>/g,"");
                        
                        Alumno = Alumno.split(":");
                        fecha = fecha.split(":");

                        win.body[count][1] = "NOMBRE: "+Alumno[1]+"\t MATRICULA: "+Alumno[2];
                        win.body[count][2] = fecha[1].substr(0,11);
                        win.body[count][0] = "";
                        win.body[count][3] = "";
                        count++;
                    });
                    
                    // for(i = 0; i < win.body.length; i++){
                    ...
                    //     fecha = fecha.split(":");
                    //     //console.log(Alumno);
                    //     win.body[i][1] = "NOMBRE: "+Alumno[1]+"\t MATRICULA: "+Alumno[2];
                    //     win.body[i][2] = fecha[1].substr(0,11);
                    //     win.body[i][0] = "";
                    //     win.body[i][3] = "";
                    // }
                }
...
$("#articulo-servicio").on('change', function(){
    ...
    var idCarrera = $("#carrera-servicio").val();
    suf_carr = $("#carrera-servicio option:selected").text();
    suf_gen = 'G'+$("#generaciones-servicio option:selected").text().split(' ')[1];
    suf_fecha = new Date().toLocaleDateString().replace(/\//g, '-');
    tablaAlumnosAsignados= $("#alumnos-select-servicio").DataTable({
        ...
        buttons:[{
            extend: "excel",
            title: `ArticulosAlumnos_${suf_carr}_${suf_fecha}_${suf_gen}`,
            className: "btn-primary"
        }, {
            extend: "pdf",
            title: `ArticulosAlumnos_${suf_carr}_${suf_fecha}_${suf_gen}`
...
$("#generacionesCalificacionesTitulados").on('change', function(){
    ...
    suf_carr = $("#carrerasCalificacionesTitulados option:selected").text();
    suf_gen = 'G'+$("#generacionesCalificacionesTitulados option:selected").text().split(' ')[1];
    suf_fecha = new Date().toLocaleDateString().replace(/\//g, '-');
    ...
    tablaAlumnosTitulados= $("#table-alumnos-titulados").DataTable({
        ...
        buttons:[{
            extend: "excel",
            title: `Titular_${suf_carr}_${suf_fecha}_${suf_gen}`,
            className: "btn-primary"
        }, {
            extend: "pdf",
            title: `Titular_${suf_carr}_${suf_fecha}_${suf_gen}`
...
$("#generacionesCalificacionesKardex").on('change', function(){
    ...
    suf_carr = $("#carrerasCalificacionesKardex option:selected").text();
    suf_gen = 'G'+$("#generacionesCalificacionesKardex option:selected").text().split(' ')[1];
    suf_fecha = new Date().toLocaleDateString().replace(/\//g, '-');
    ...
    tCalificaciones = $("#table-alumnos-calificacionesKardex").DataTable({
        ...
        buttons:[{
            extend: "excel",
            title: `Kardex_${suf_carr}_${suf_fecha}_${suf_gen}`,
            className: "btn-primary"
        }, {
            extend: "pdf",
            title: `Kardex_${suf_carr}_${suf_fecha}_${suf_gen}`
...
$("#cicloCalificacionesBoletas").on('change', function(){
    ...
    suf_carr = $("#carrerasCalificacionesBoletas option:selected").text();
    suf_gen = 'G'+$("#generacionesCalificacionesBoletas option:selected").text().split(' ')[1];
    suf_fecha = new Date().toLocaleDateString().replace(/\//g, '-');
    ...
    tCalificaciones = $("#table-alumnos-calificacionesBoletas").DataTable({
        ...
        buttons:[{
            extend: "excel",
            title: `Boletas_${suf_carr}_${suf_fecha}_${suf_gen}`,
            className: "btn-primary"
        }, {
            extend: "pdf",
            title: `Boletas_${suf_carr}_${suf_fecha}_${suf_gen}`
...
function LlenadoTablaNoAcreditado(idMateria,idGeneracion){
    ...
    suf_carr = $("#carrerasCalificaciones_noAcre option:selected").text();
    suf_gen = 'G'+$("#generacionesCalificaciones_noAcre option:selected").text().split(' ')[1];
    materia = $("#MateriaCalificacion_noAcre option:selected").text();
    suf_fecha = new Date().toLocaleDateString().replace(/\//g, '-');
    tCaficaciones = $("#table-alumnos-calificacionesNoAcre").DataTable({
            ...
            buttons:[{
                ...
                extend: "excel",
                title: `NoAcreditados_${suf_carr}_${materia}_${suf_fecha}_${suf_gen}`,
                className: "btn-primary",
                exportOptions: {
...
function consultarCalificaciones(idMateria, idGeneracion){
    ...
    suf_carr = $("#carrerasCalificaciones option:selected").text();
    suf_gen = 'G'+$("#generacionesCalificaciones option:selected").text().split(' ')[1];
    suf_fecha = new Date().toLocaleDateString().replace(/\//g, '-');
    tCaficaciones = $("#table-alumnos-calificaciones").DataTable({
            ...
            buttons:[{
                ...
                extend: "excel",
                title: `Calificaciones_${suf_carr}_${suf_fecha}_${suf_gen}`,
                className: "btn-primary",
                exportOptions: {
                    customizeData: function (d) {
                        var i = 0;
                        d.body.forEach(function(element){
                            d.body[i][1] = element[1];
                            d.body[i][2] = '';
                            i++;
                        });
                    }

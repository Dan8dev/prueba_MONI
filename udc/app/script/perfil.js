...
$(".tltipbloqueo").each(function(){
  $(this).html(`<i class="fa fa-info-circle" aria-hidden="true"></i><span class="tuiltiptext"><small>Si requiere actualizar alguno de sus datos solicitelo a <b>control escolar</b></small></span>`);
})
  ...
  $.ajax({
    ...
    complete: function () {
      ...
      $.post("data/CData/afiliadosControl.php", { action: "obtenerdatosperfil" }, function (data1) {
        ...
        $('#inp_mail').val(data1.email)
        $('#celular').val(data1.celular)
        $('#inp_celular').val(data1.celular)

        ...
        switch($_GET["ST"])
        {
            case "SUCCESS":
                ...
                ?>
                    ...
                    <script>
                        document.getElementById("IDForm").action = "https://sandbox.conacon.org/siscon/app/claseswebex/unirsealasesion.php?sesion=<?php echo $_GET['sesion']; ?><?php echo (isset($_GET['evento']) ? "&evento=".$_GET['evento'] : '');  ?>";

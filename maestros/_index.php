                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-12">
                      ...
                      <li class="nav-item">
                          <a class="nav-link <?php if( !isset($_GET['p'] ) ) echo "active"; ?> <?php if( isset($_GET['p']) && $_GET['p'] == 'editarClase' ) echo 'iactive'; ?> <?php if( isset($_GET['p']) && $_GET['p'] == 'editar' ) echo 'iactive'; ?>" data-toggle="tab" id="alumnos-tab" href="#alumnos" role="tab" aria-controls="alumnos"  aria-selected="false" data-target="#alumnos">
                      ...
                      <li class="nav-item">
                          <a class="nav-link <?php if( isset($_GET['p']) && $_GET['p'] == 'editar' ) echo 'active'; ?>" data-toggle="tab" id="tareas-tab" href="#tareas" role="tab" aria-controls="tareas" aria-selected="true" data-target="#tareas">
                        ...
                        <li class="nav-item">
                          <a class="nav-link <?php if( isset($_GET['p']) && $_GET['p'] == 'editarClase' ) echo 'active'; ?>" data-toggle="tab" id="clases-tab" href="#clases" role="tab" aria-controls="clases" aria-selected="true" data-target="#clases">
                      ...
                      <div class="tab-content bg-light">
                        <div class="row tab-pane fade show <?php if( !isset($_GET['p'] ) ) echo "active"; ?> <?php if( isset($_GET['p']) && $_GET['p'] == 'editar' ) echo 'iactive'; ?>" id="alumnos" role="tabpanel" aria-labelledby="alumnos-tab">
                              ...
                              <table id="listado_prospectos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; width: 100%;">
                                ...
                                if( $resultado->num_rows > 0 ){?>
                                  <?php while( $fila = $resultado->fetch_assoc() ){?>
                                    ...
                                    <th><?=$fila['titulo']?></th>
                                    <th><?=$fila['nombre']?></th>
                                    <th><?=$fila['fecha_entrega']?></th>
                                    <th><a href="#" title="<?=$fila['comentario']?>"><?=$fila['comentario']?>...</a></th>
                                    <th>
                                      <form method="get">
                                        <select  class="form-control" onChange="MM_jumpMenu('parent',this,0)" id="calificacion" name="calificacion">
                                          <?php for( $i = 5; $i<=10; $i++ ){
                                    ...
                                    <th>
                                    <a class="btn btn-primary waves-effect waves-light" href="<?=$fila['archivo']?>" target="_blank">Ver</a>  
                                    <!--<a class="btn btn-primary waves-effect waves-light" href="index.php?p=calificar&idTarea=<?=$fila['idTarea']?>">Calificar</a>  -->
                                    <!--<a class="btn btn-secondary waves-effect waves-light" href="eliminarTarea.php?idTarea=<?=$fila['idTarea']?>">Eliminar</a></th>-->
                                  </tr>
                                    <?php }?>
                                <?php } ?>                               
                        ...
                        <div class="row tab-pane fade show <?php if( isset($_GET['p']) && $_GET['p'] == 'editar' ) echo 'active'; ?>" id="tareas" role="tabpanel" aria-labelledby="profile-tab">
                          <div class="table-responsive">
                            ...
                            <div class="col-lg-12 col-sm-12 col-md-12 TBNR">
                              ...
                              <table id="listado_prospectos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; width: 100%;">
                                ...
                                if( $resultado->num_rows > 0 ){?>
                                  <?php while( $fila = $resultado->fetch_assoc() ){?>
                                    <tr>
                                    <th><?=$fila['nombreCurso']?></th>
                                    <th><?=$fila['nombreClase']?></th>
                                    <th><?=$fila['tituloTarea']?></th>                                    
                                    <th><?=$fila['descripcion']?>...</th> 
                                    <th>
                                    <a class="btn btn-primary waves-effect waves-light" href="index.php?p=editar&idTarea=<?=$fila['idTareas']?>">Editar</a>  
                                    <a class="btn btn-secondary waves-effect waves-light" href="eliminarTarea.php?idTarea=<?=$fila['idTareas']?>">Eliminar</a></th>
                                  </tr>
                                    <?php }?>
                                <?php } ?>                               
                        ...
                        <!--LISTADO DE CLASES-->
                        <div class="row tab-pane fade show <?php if( isset($_GET['p']) && $_GET['p'] == 'editarClase' ) echo 'active'; ?>" id="clases" role="tabpanel" aria-labelledby="profile-tab">
                          <div class="table-responsive">
                              ...
                              <table id="listado_prospectos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; width: 100%;">
                                ...
                                if( $resultado->num_rows > 0 ){?>
                                  <?php while( $fila = $resultado->fetch_assoc() ){?>
                                    ...
                                    <!--<th><?=$fila['descripcion']?>...</th> -->
                                    <th>
                                    <a class="btn btn-primary waves-effect waves-light" href="index.php?p=editarClase&idClase=<?=$fila['idClase']?>">Editar</a>  
                                    <a class="btn btn-secondary waves-effect waves-light" href="eliminarClase.php?idClase=<?=$fila['idClase']?>">Eliminar</a></th>
                                  </tr>
                                    <?php }?>
                                <?php } ?>                               

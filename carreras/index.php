                        ...
                        <div class="page-title-inner d-inline-block">
                            ...
                            <?php
                                if ($_GET['e']=='carrera-alumnos-tsu') {
                                    ...
                                    <!-- poner un logo -->
                                    <br>
                                    <img src="../assets/images/generales/logos/logo-tsu.png" alt="">
                                     <?php
                                }
                            ?>
                                                ...
                                                <div class="col-md-12 col-sm-12 col-lg-12">
                                                    ...
                                                    <?php
                                                        if ($_GET['e']=='carrera-alumnos-tsu') {
                                                            ?>
                                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                                <select class="w-100 select select-texto">
                                                                    <option value="" selected>RENAPRE</option>
                                                                </select>
                                                            </div>
                                                            <?php
                                                        }
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-lg-12" id="mostrarinstituciones">

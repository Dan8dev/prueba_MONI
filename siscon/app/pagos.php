    ...
    <!-- <div class="ht-70 bg-gray-100 pd-x-20 d-flex align-items-center justify-content-center shadow-base">
      <ul class="nav nav-outline active-info align-items-center flex-row" role="tablist">
        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#posts" role="tab">
           <span class="d-block d-sm-none"><i class="icon ion-briefcase"></i></span>
						<span class="d-none d-sm-block"><i class="icon ion-briefcase"></i> Pagos</span>
        </a></li>
        <li id="estado_de_cuenta" class="nav-item"><a class="nav-link" data-toggle="tab" href="#photos" role="tab"

        </a></li>
        <li id="tab_plan_de_pagos" class="nav-item"><a class="nav-link" data-toggle="tab" href="#plan_de_pagos" role="tab">  
          
        </a></li>
      </ul>
    </div> -->
     <h2 class="tx-uppercase"> <img src="img/pageprofile/pagos.png"> pagos</h2>

    <div class="ht-70 bg-gray-100 pd-x-20 d-flex align-items-center justify-content-center shadow-base">
      <ul class="nav nav-outline active-info align-items-center flex-row" role="tablist">
         <li class="nav-item"><a class="nav-link active tx-uppercase" data-toggle="tab" href="#posts" role="tab">
            <span class="d-block d-sm-none "><i class="icon ion-briefcase   fa-lg"></i></span>
						<span class="d-none d-sm-block "><i class="icon ion-briefcase   fa-lg"></i> Pagos</span></a>
         </li>
        <li id="estado_de_cuenta" class="nav-item"><a class="nav-link tx-uppercase" data-toggle="tab" href="#photos" role="tab">
          <span class="d-block d-sm-none"><i class="icon ion-archive  fa-lg"></i></span>
          <span class="d-none d-sm-block"><i class="icon ion-archive  fa-lg"></i> Estado de cuenta</span></a>
        </li>
        <li id="tab_plan_de_pagos" class="nav-item"><a class="nav-link tx-uppercase" data-toggle="tab" href="#plan_de_pagos" role="tab">
          <span class="d-block d-sm-none"><i class="icon ion-pie-graph  fa-lg"></i></span>
          <span class="d-none d-sm-block"><i class="icon ion-pie-graph  fa-lg"></i> Plan de pagos</span></a>
        </li>
      </ul>
    </div>
            ...
            <div class="opps" id="foto_ficha_oxxo">
              ...
              <div class="opps-instructions">
                ...
                <div class="opps-footnote">
                  <strong>Tu pago se verifica en automático no necesitas reportarlo</strong>
                </div>
                <br>
                <form action="https://moni.com.mx/marketing-educativo/descargar_ficha_oxxo.php" method="post" target="_blank">
                  ...
                  <input type="hidden" name="sitiomoni" value="monicom">
              ...
              <div class="form-layout form-layout-4">
                ...
                <div class="row mg-t-20" style="display:none" id="mostrarmetododepago">
                  <label class="col-sm-4 form-control-label" for="metododepago">Seleccione el método de pago</label>
                    <!-- <i class="icon ion-information-circled col-sm-1 fa-lg" id="informacionPago" title="Clic para ver ejemplo de pago"></i> -->
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <select class="form-control" name="metodo_de_pago" id="metododepago" required>
                      ...
                      <option id="transferenciaelectronica" style="display:none" value="Transferencia eletrónica">Transferencia eletrónica</option>
                ...
                <div class="row mg-t-20">
                  <label class="col-sm-4 form-control-label">Monto pagado: <span id="tipodemonedamontopagado"></span> </label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input class="form-control" type="tel" required id="inp_monto_pago" name="inp_monto_pago"  data-prefix="$ " value="$ 0.00"></input>
                  </div>
                </div>
              </div><!-- form-layout -->
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content col-sm-12 col-lg-12">
          ...
          <div class="modal-body">
            ...
            <img class="col-sm-10 center" src="" name="verEjemploComprobante" id="verEjemploComprobante" alt="Responsive image" style="display: none;">

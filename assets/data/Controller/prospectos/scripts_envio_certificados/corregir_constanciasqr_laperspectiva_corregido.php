<?php
	...
	$constancias = $con->query('SELECT * 
									...
									WHERE ae.id_evento = 2 and ae.id_taller=4')->fetchAll(PDO::FETCH_ASSOC);
	...
	foreach ($constancias as $row => $values) {
		...
		$plantilla = '';
			...
			$plantilla = '../../../functions/plantillas_constancias/laperspectiva_corregido.jpg';
		...
		$sql = "UPDATE asistentes_eventos set nombre_reconocimiento='$nombre_reconocimiento' WHERE id_asistente='".$values['id_asistente']."' AND id_evento=2 AND id_taller=4";

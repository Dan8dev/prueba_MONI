...
$("#select-clase").on('change', function(){
	...
	if(clase){
		...
		$("#content_tareas").html((hwks != '')? hwks : 'Aún no hay tareas para esta clase');
			...
			if(clase.foto.trim() != ''){
				$("#image-clase").attr("src",'https://moni.com.mx/assets/files/clases/fotoClase/'+clase.foto); // <- solo para el panel de siscon, que está en otro dominio
			}
...
moni.com.mx/assets/images/portadamoni.png" alt="Image"></a>
				...
				if(mensaje != ''){
					$("#cursos-container").append(`<div class="alert alert-bordered alert-warning text-dark" role="alert" style="max-height: 100px;">

...
<body>
  ...
  <main>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-6" >
              ...
              <p style="text-align: justify;">T​e doy la más cordial bienvenida a mi página. Para mi es de suma
                importancia incluirte en todo lo que aquí comunico y que seas parte
                ...
                más contundente al mundo de la salud mental y la prevención de las
                Conductas Antisociales.
                Necesitamos generar una comunicación productiva, en donde tu
                retroalimentación y la mía sean parte de una comunicación efectiva y
    ...
    <div id="grados" class="page-section">
      <div class="container">
        <h2 style="color: #4478ad;"><b><u>Grados Académicos</u></b></h2>
    ...
    <h2 style="color: #4478ad;"><b><u>CONTACTO</u></b></h2>
      <div class="row">
        ...
        <div class="col-lg-3 py-3">
            ...
            <span style="color:#4478ad"><img src="img/map.png" width="22px"> <b>Dirección:</b><br><?=$persona['estado_nom']?></span><br><br>          
        </div>
        <div class="col-lg-6 py-3">

    ...
    <div class="container container-fluid">
        <div class="row">
            ...
            <div class="col-sm-4 pe-0">
                ...
                <div class="mb-2">
                    <a class="btn prev"><img class="rotation-left" src="./design/icons/left-arrow-gy.png"> Clase previa </a>
                    <a class="btn float-end next"> Siguiente clase <img class="rotation-right" src="./design/icons/left-arrow-gy.png" alt=""> </a>
                </div>

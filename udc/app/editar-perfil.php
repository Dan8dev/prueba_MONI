        ...
        <div class="br-section-wrapper">         
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-t-20 mg-b-10">Editar perfil</h6>
            <div class="container" align="center">
              <br/>
              <h3 align="center"><?php if(!$HIDE_OPTIONS) echo 'Cargar foto de perfil'; ?></h3>
              <br/>
              <div class="col-md-5">
                <div class="image_area"><!--Nuevo-->
                  <form method="post">
                    ...
                    <?php 
                      ...
                      if(isset($HIDE_OPTIONS) && !$HIDE_OPTIONS):
                    ?>
          ...
          <div id="wizard2">
            ...
            <section>
              ...
              <div class="form-group wd-xs-300">
                ...
                <?php if($generaciones_asignadas > 0): ?>
                  <input class="form-control special disabled" type="text" disabled id="first_name"  title="ESTE CAMPO HA SIDO BLOQUEADO PARA SU EDICIÓN POR MOTIVOS DE CONTROL ESCOLAR."> <div class="tuiltip float-right tltipbloqueo"></div>
              ...
              <div class="form-group wd-xs-300">
                ...
                <?php if($generaciones_asignadas > 0): ?>
                  <input class="form-control special disabled" type="text" disabled id="ape_paterno"  title="ESTE CAMPO HA SIDO BLOQUEADO PARA SU EDICIÓN POR MOTIVOS DE CONTROL ESCOLAR."><div class="tuiltip float-right tltipbloqueo"></div>
              ...
              <div class="form-group wd-xs-300">
                ...
                <?php if($generaciones_asignadas > 0): ?>
                  <input class="form-control special disabled" type="text" disabled id="ape_materno"  title="ESTE CAMPO HA SIDO BLOQUEADO PARA SU EDICIÓN POR MOTIVOS DE CONTROL ESCOLAR."><div class="tuiltip float-right tltipbloqueo"></div>
              ...
              <div class="form-group wd-xs-300 d-none">
              ...
              <div class="form-group wd-xs-300 d-none">
                ...
                <?php if($generaciones_asignadas > 0): ?>
                  <input class="form-control special disabled" type="text" disabled id="c_curp"  title="ESTE CAMPO HA SIDO BLOQUEADO PARA SU EDICIÓN POR MOTIVOS DE CONTROL ESCOLAR."> <div class="tuiltip float-right tltipbloqueo"></div>
            ...
            <section>
              ...
              <div class="form-group wd-xs-300">
                ...
                <?php if($generaciones_asignadas > 0): ?>
                  <input class="form-control disabled" type="text" disabled id="inp_mail"  title="ESTE CAMPO HA SIDO BLOQUEADO PARA SU EDICIÓN POR MOTIVOS DE CONTROL ESCOLAR."> <div class="tuiltip float-right tltipbloqueo"></div>
                  <input id="email" name="email" type="hidden" readonly>
                <?php else: ?>
              ...
              <div class="form-group wd-xs-300">
                ...
                <?php if($generaciones_asignadas > 0): ?>
                  <input class="form-control disabled" type="text" disabled id="inp_celular"  title="ESTE CAMPO HA SIDO BLOQUEADO PARA SU EDICIÓN POR MOTIVOS DE CONTROL ESCOLAR."><div class="tuiltip float-right tltipbloqueo"></div>
                  <input id="celular" name="celular" type="hidden" readonly>
                <?php else: ?>

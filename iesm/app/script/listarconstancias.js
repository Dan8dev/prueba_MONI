$.post("../../assets/data/Controller/asistentes/asistentesControl.php",{action: "obtenerconstancias",emailobtener:$('#emailobtener').text()}, function(data3, status){
    ...
    for ( index = 0; index < data3.length; index++) {
      ...
      listar+=`<div class="col card shadow-base bd-0">
              <div class="card-header card-body d-flex justify-content-between align-items-center bg-primary">
 ...
 $.post("../../assets/data/Controller/asistentes/asistentesControl.php",{action: "obtenergrados",emailobtener:$('#emailobtener').text()}, function(data4, status){
    ...
    var listar_grado=`
      <div class="row">
        <div class="col-sm-12" style="height:35vh; overflow:auto;">
          <div class="row"><table class="table"><thead><th>Grado</th><th>Titulo</th><th>Cédula</th></thead>
    `;
    // listar_grado+= `
    //         <div class="row">
    //           <div class="col-sm-12 col-md-6 mx-auto d-flex align-items-center">
    //             <i class="fa fa-graduation-cap tx-80 lh-0 tx-teal op-5"></i>
    //             <div class="ml-4">
    //               <strong>${data4[index2].grado}</strong><p>${data4[index2].titulo}</p><i>${data4[index2].cedula}</i>
    //             </div>
    //           </div>
    //         </div>
    //         <hr>

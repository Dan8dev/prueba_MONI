                              ...
                              <input type="text" class="form-control" name="id" id="id" value ="<?php echo $info['id'];?>" style="display:none" required>
                                ...
                                <div class="form-group row">
                                  <div class="form-group col-md-12 container">
                                      <label for="Descripcion"><h5>Agregue una breve descripción de su perfil:</h5></label>
                  ...
                  <div class="tab-content bg-light">
                        ...
                        <div class="card">
                          <div class="card-body">
                            <div class="table-responsive">
                              <h2 class="m-b-30 m-t-0">Éstas son las tareas a revisar y calificar:</h2>
                      ...
                      <div class="container col-sm-12 col-lg-12">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <div class="table-responsive">
                              <h2 class="m-b-30 m-t-0">Éstas son las tareas que usted ha subido:</h2>
                    ...
                    <div class="row tab-pane fade" id="clases" role="tabpanel" aria-labelledby="clases-tab">
                      <div class="container col-sm-12 col-lg-12">
                        <div class="card">
                          <div class="card-body">
                            <div class="table-responsive">
                              <h2 class="m-b-30 m-t-0">Éstas son sus clases asignadas:</h2>
                    ...
                    <div class="row tab-pane fade" id="calificaciones-tab" role="tabpanel" aria-labelledby="calificaciones-tab2">
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-4">
                          <label for="select-generacion">Selecciona una generación</label>
                      ...
                      <div class="col-12 table-responsive">
                        ...
                        <h4>Escriba una calificación en un rango del 0 al 10. <br>O en su defecto una '<b><i>s</i></b>' para <b>Sin calificación</b> ó '<b><i>n</i></b>' para <b>N/C</b> </h4>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form id="formularioCrearTarea" type="post">
                            ...
                            <div class="form-group">
                              <label for="descripcionTarea">Descripción de la Tarea (Instrucciones):</label>
                            ...
                            <div class="form-group">
                              <label for="fechaLimiteTarea">Fecha/Hora límite para que el alumno entregue la tarea:</label>
                            ...
                            <div class="form-group">
                              <label for="claseDocente">Clase a la que pertenecerá la tarea:</label>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form id="formularioCalificarTarea" type="post">
                              ...
                              <div class="form-group">
                                <label for="retroalimentacionAlumno">Retroalimentación al alumno:</label>
                                <input name="retroalimentacionAlumno" id="retroalimentacionAlumno" type="text" class="form-control" placeholder="Ingresa la retroalimentación al alumno..." required>    
                              </div>

                              <div class="form-group">
                                <label for="calificaciones">Calificar tarea:</label>
                                <select class="form-control" name="calificaciones" id="calificaciones" required>
                                  <option value="" selected="true" disabled="disabled">Seleccione Calificación</option>
                  ...
                  <ul class="nav nav-tabs" id="myTabs" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" id="listado_examenes_tab" data-toggle="tab" data-target="#listExamenes" href="#listExamenes" role="tab" aria-controls="listExamenes" aria-selected="false">
                        ...
                        <span class="d-none d-sm-block">Listado de exámenes</span>
                      </a>
                    </li>
                  </ul>
                  <div class="tab-content bg-light">
                      ...
                      <div class="container col-sm-12 col-lg-12">
                        <div class="card">
                          ...
                          <!--<div class="text-right">
                            ...
                            <div class="table-responsive">
                              <center><h2 class="m-b-30 m-t-0">Listado de Exámenes:</h2></center>
                              <div class="form-group">
                    ...
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              <label for="cursoExamen">Curso al que pertenecerá el examen: </label>
                              <select class="form-control" name="cursoExamen" id="cursoExamen" required>
                              </select>
                            </div>

                            <div class="form-group">
                              <label>Rango de fechas en las que el alumno podrá presentar el examen: </label>
                            ...
                            <div class="form-group">
                              <strong>Pregunta 1</strong>
                                ...
                                <input type="text" name="TextoOpcionExamen0_A" id="TextoOpcionExamen0_A" style="border-color: transparent;" placeholder="Opción A..." required="required">
                                <input type="radio" class="OpcionExamen0" name="OpcionExamen0" value="B" title="Marcar ésta opción como la correcta">
                                <input type="text" name="TextoOpcionExamen0_B" id="TextoOpcionExamen0_B" style="border-color: transparent;" placeholder="Opción B...">
                                <input type="radio" class="OpcionExamen0" name="OpcionExamen0" value="C" title="Marcar ésta opción como la correcta">
                                <input type="text" name="TextoOpcionExamen0_C" id="TextoOpcionExamen0_C" style="border-color: transparent;" placeholder="Opción C...">
                                <input type="radio" class="OpcionExamen0" name="OpcionExamen0" value="D" title="Marcar ésta opción como la correcta">
                                <input type="text" name="TextoOpcionExamen0_D" id="TextoOpcionExamen0_D" style="border-color: transparent;" placeholder="Opción D...">
                            </div>
                            ...
                            <div class="form-group">
                              <strong>Pregunta 2</strong>
                                ...
                                <input type="text" name="TextoOpcionExamen1_A" id="TextoOpcionExamen1_A" style="border-color: transparent;" placeholder="Opción A..." required="required">
                                <input type="radio" class="OpcionExamen1" name="OpcionExamen1" value="B" title="Marcar ésta opción como la correcta">
                                <input type="text" name="TextoOpcionExamen1_B" id="TextoOpcionExamen1_B" style="border-color: transparent;" placeholder="Opción B...">
                                <input type="radio" class="OpcionExamen1" name="OpcionExamen1" value="C" title="Marcar ésta opción como la correcta">
                                <input type="text" name="TextoOpcionExamen1_C" id="TextoOpcionExamen1_C" style="border-color: transparent;" placeholder="Opción C...">
                                <input type="radio" class="OpcionExamen1" name="OpcionExamen1" value="D" title="Marcar ésta opción como la correcta">
                                <input type="text" name="TextoOpcionExamen1_D" id="TextoOpcionExamen1_D" style="border-color: transparent;" placeholder="Opción D...">
                            </div>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <div class ="form-group row d-flex justify-content-end">
                              <label for="totalPregExamen" class="col-sm-3 control-label">Número de preguntas a aplicar del total de preguntas agregadas:</label>
                              <div class="col-sm-4">
              ...
              <div class="modal-content col-sm-12 col-lg-12">
                ...
                <div class="modal-body">
                  <form id="formularioModificar" type="post">
                    ...
                    <div class ="form-group row d-flex justify-content-end">
                        <label for="editTotalPregExamen" class="col-sm-3 control-label">Número de preguntas a aplicar del total de preguntas agregadas:</label>
                          <div class="col-sm-4">
              ...
              <div class="modal-content col-sm-12 col-lg-12">
                ...
                <div class="modal-body">
                  <form id="formularioModificarTarea" type="post">
                    ...
                    <div class="form-group">
                      <label for="editDescripcionTarea">Descripción de la Tarea (Instrucciones): </label>
                    ...
                    <div class="form-group">
                      <label for="editFechaLimiteTarea">Fecha/Hora límite para que el alumno entregue la tarea: </label>
                    ...
                    <div class="form-group">
                      <label for="editClaseTarea">Clase al que pertenecerá la tarea: </label>

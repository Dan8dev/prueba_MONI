...
function generar($prospecto, $carrera){
    ...
    function show_info($info){
        ...
        for($c = 0; $c < sizeof($info['conceptos']); $c++){
            ...
            $str_fecha_conce_mens = $info['conceptos'][$c]['fechalimitepago'] != null ? substr($info['conceptos'][$c]['fechalimitepago'], 0, 10):'-';
            $concepto_arr = [
